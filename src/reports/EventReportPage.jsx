...
import {
  FormControl, InputLabel, Select, MenuItem, Table, TableHead, TableRow, TableCell, TableBody, Link, IconButton, TablePagination,
} from '@mui/material';
...
const EventReportPage = () => {
  ...
  // Set default columns
  const columns = ['eventTime', 'type', 'attributes'];
