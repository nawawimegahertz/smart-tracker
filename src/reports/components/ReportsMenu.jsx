...
import StarIcon from '../ReportsIcons/star-icon.png';
// import TimelineIcon from '@mui/icons-material/Timeline';
import PauseCircleFilledIcon from '../ReportsIcons/pause-icon.png';
import PlayCircleFilledIcon from '../ReportsIcons/play-icon.png';
import NotificationsActiveIcon from '../ReportsIcons/notification-icon.png';
import FormatListBulletedIcon from '../ReportsIcons/summary-icon.png';
// import TrendingUpIcon from '@mui/icons-material/TrendingUp';
// import BarChartIcon from '@mui/icons-material/BarChart';
import RouteIcon from '../ReportsIcons/replay-icon.png';
